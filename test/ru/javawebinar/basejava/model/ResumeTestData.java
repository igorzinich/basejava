...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        resume.getSections().put(SectionType.QUALIFICATIONS, new StringSection("JEE AS: GlassFish (v2.1, v3), OC4J, JBoss, Tomcat, Jetty, WebLogic, WSO2\n" +
        ...
        resume.getSections().put(SectionType.ACHIEVEMENT, new StringSection("Организация команды и успешная реализация Java проектов для сторонних заказчиков: приложения автопарк на стеке Spring Cloud/микросервисы, система мониторинга показателей спортсменов на Spring Boot, участие в проекте МЭШ на Play-2, многомодульный Spring Boot + Vaadin проект для комплексных DIY смет\n" +
