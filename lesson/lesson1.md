...
- Реализуйте методы `save, get, delete, clear, getAll, size` в классе `com.javawebinar.basejava.storage.ArrayStorage`,
...
- Проверьте вашу реализацию с помощью классов `com.javawebinar.basejava.MainArray.main()`
  и `com.javawebinar.basejava.MainTestArrayStorage.main()`
...
1. В методе `clear()` обнуление массива предполагает обнуление (null) ячеек, где хранятся
   com.javawebinar.basejava.model.Resume, а не создание нового или присваивание ему null
...
1. com.javawebinar.basejava.model.Resume r — давайте переменным осмысленные имена, например resume. r допустимо в
